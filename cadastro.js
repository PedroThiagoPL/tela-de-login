...
nome.addEventListener('keyup', () => { //Assim que digitar o keyup vai executar a função abaixo
    if(nome.value.length <= 2){ //Se a quantidade de caractere for menor ou igual que 2 ficará...
        labelNome.setAttribute('style', 'color: red') //...Vermelho
        labelNome.innerHTML = 'Nome *Insira no mínimo 3 caracteres'
        nome.setAttribute('style', 'border-color: red')
        validNome = false
    } else {
        labelNome.setAttribute('style', 'color: green') //...Verde
...
senha.addEventListener('keyup', () => {
    if(senha.value.length <= 7){
        ...
        labelSenha.innerHTML = 'Usuário *Insira no mínimo 8 caracteres'
